...
def predict(coords_dir, coords_path):
    ...
    #### Step 2: Search names and ensemble name
    search_names = ['21092022 1522 IM2021', '22092022 1214 IM2021'] # <--- Enter the names of your searches
    ensemble_name = '092022 IM2021'
    ...
    ensemble_dir = os.path.join(project_dir, 'ensembles', ensemble_name) 
    results_dir = os.path.join(ensemble_dir, os.path.dirname(coords_dir))
